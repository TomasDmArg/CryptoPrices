...
const setDown = i =>{
    ...
    $$('.card-image-img')[i].style.border = '3px solid #ff411f';
}
const setUp = i =>{
    ...
    $$('.card-image-img')[i].style.border = '3px solid #06D6A0';
}
...
.then(data => {
    ...
    for (let i = 0; i < 100; i++) {
            ...
            let timer = setInterval(()=>{
                if($$('.card__name-container > h2')[0].innerHTML === '' || $$('.card__name-container > h2').innerHTML === null){
                    for (let i = 0; i < $$('.card__name-container').length; i++) {
                        $$('.card__name-container')[i].style.animationDuration = '.8s';
                    }
                }else{
                    for (let i = 0; i < $$('.card__name-container').length; i++) {
