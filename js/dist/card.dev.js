...
var nameArr = (0, _selector.$$)('.card__name-container > h2');
var symbolArr = (0, _selector.$$)('.card__name-container > h4');
var priceArr = (0, _selector.$$)('.card-container > section > .price');
var changeArr = (0, _selector.$$)('.percent');
var imgArr = (0, _selector.$$)('.card-image-img');
var converterTextArr = (0, _selector.$$)('.bg-text');
var converterInputArr = (0, _selector.$$)('.converter-input');
var converterCurrencyArr = (0, _selector.$$)('.converter-currency');
...
var initCards = function initCards() {
  var setDown = function setDown(i) {
    ...
    (0, _selector.$$)('.card-container')[i].style.border = '5px solid #ff411f';
  ...
  var setUp = function setUp(i) {
    ...
    (0, _selector.$$)('.card-container')[i].style.border = '5px solid #06D6A0';
  ...
  fetch('https://cors.bridged.cc/https://app.ripio.com/api/v3/rates/?country=AR').then(function (response) {
    ...
    (0, _selector.$)('#buyDollar').innerHTML = "$" + data2[3].buy_rate;
    (0, _selector.$)('#sellDollar').innerHTML = "$" + data2[3].sell_rate;
